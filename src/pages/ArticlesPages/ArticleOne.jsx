    ...
    <body className="" id="homePage">
      ...
      <div className='containerColumn'>
        ...
        <div className='containerOnly'>
          ...
          <p className='paragraphPt'>A Praia do Pontal é a mais próxima do centro histórico de Paraty: basta cruzar a pontezinha situada ao lado da Praça da Matriz que você já estará nesta vizinhança.
          ...
          <p className='paragraphPt'>A Praia do Jabaquara é outra das praias centrais de Paraty e que se encontra a uma curta caminhada do centro-histórico: cerca de 20 minutos andando. Porém, apesar do fácil acesso, ela não é nem de longe uma das melhores praias de Paraty.
          ...
          <p className='paragraphPt'>Localizada a 25 quilômetros do centro da cidade, a Vila de Trindade é um dos destinos mais concorridos pelos viajantes que querem aproveitar as praias de Paraty. Inclusive, é um lugar que sempre faço questão de voltar.
          ...
          <p className='paragraphPt'>Selvagem e hospitaleiro, assim é o ambiente que você encontrará na Praia do Sono.
          ...
          <p className='paragraphPt'>A Praia da Lula é, para mim, a parada que faz o tradicional passeio de escuna em Paraty valer a pena.
          ...
          <p className='paragraphPt'>A 30 quilômetros do centro de Paraty, sentido Angra dos Reis, a Praia de São Gonçalo é uma boa pedida para quem gosta de praias com uma estrutura legal à beira mar, mas nem por isso quer ficar em um ambiente completamente urbano.
          ...
          <p className='paragraphPt'> Outro lugar para incluir no roteiro da sua viagem a Paraty é Paraty-Mirim, que fica a 15 quilômetros distante do burburinho central.
          ...
          <p className='paragraphPt'>Apesar de indicar a Praia Grande neste texto, pelo simples fato dela ter sido a minha favorita durante um passeio de barco, saiba que o Saco do Mamanguá possui dezenas de refúgios que poderiam facilmente ocupar um espaço nas listas de melhores praias de Paraty.
            ...
            Para quem curte passeios de barco – no caso lanchas rápidas – fazer um tour pelo Saco do Mamanguá é uma escolha certeira.
            <br />
            <br />
            <br />
          ...
          <p className='paragraphPt'>Apesar de seu belo cenário que por si só já valeria a visita, a indicação da Praia do Cruzeiro tem outro motivo. Isso porque, é daqui onde se inicia um dos melhores passeios para fazer em Paraty: a Trilha do Pico do Pão do Açúcar.
