export default function SocialLinks() {
    return(
        ...
        <ul className="socialLogo">
            ...
            <li className="instagram">
              ...
              target="_blank" rel="noreferrer">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="#00856F" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M17.5 6.49997H17.51" stroke="#00856F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </a>
            </li>
          ...
          <li className="facebook">
              ...
              target="_blank" rel="noreferrer">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="#00856F" xmlns="http://www.w3.org/2000/svg">
                  <path 
                  d="M18 1.99997H15C13.6739 1.99997 12.4021 2.52675 11.4645 3.46444C10.5268 4.40212 10 5.67389 10 6.99997V9.99997H7V14H10V22H14V14H17L18 9.99997H14V6.99997C14 6.73475 14.1054 6.4804 14.2929 6.29286C14.4804 6.10533 14.7348 5.99997 15 5.99997H18V1.99997Z" stroke="#00856F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </a>
          </li>
        ...
        <li className="google">
          ...
          target="_blank" rel="noreferrer">
            <svg id="google" width="24" height="24" viewBox="0 0 24 24" fill="#00856F" xmlns="http://www.w3.org/2000/svg">
